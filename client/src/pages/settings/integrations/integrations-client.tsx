  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Connect Jira or Confluence and trigger syncs. Requires gateway and integration-service. Your
            personal Jira API token (per browser) is configured under{" "}
            <Link to="/account#jira" className="text-indigo-400 hover:text-indigo-300">
              Account
            </Link>
            .
          </p>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-950/40 p-4 text-sm text-slate-300">
        <span className="font-medium text-slate-200">Personal Jira (API token)</span> is configured per user
        under{" "}
        <Link to="/account#jira" className="text-indigo-400 underline hover:text-indigo-300">
          Account → Jira
        </Link>
        . Workspace connections below use server-stored integration records.
      </div>
